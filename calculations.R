...
file_name <- readline(prompt = "Enter the name of the file where you want to store the data: 'ex control or drug'")
...
cat(red("Move to line 26 or repeat line 21 to add another condition"))